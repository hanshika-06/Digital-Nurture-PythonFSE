...
INSERT INTO students (first_name, last_name, email, date_of_birth, department_id, enrollment_year) VALUES
('Neha', 'Sharma', 'neha.sharma@college.edu', '2004-05-18', 1, 2023),
('Amit', 'Patel', 'amit.patel@college.edu', '2003-12-10', 2, 2022);

-- 17. Update grade of student_id = 5 for course_id = 1 from 'C' to 'B'
...
WHERE salary BETWEEN 80000.00 AND 95000.00;
...
-- 27. Find all students who are NOT enrolled in any course using LEFT JOIN and WHERE ... IS NULL
SELECT s.student_id, CONCAT(s.first_name, ' ', s.last_name) AS student_name
FROM students s
LEFT JOIN enrollments e ON s.student_id = e.student_id
WHERE e.enrollment_id IS NULL;

-- 28. Display every course along with the number of students enrolled in it. (LEFT JOIN courses with enrollments)
...
-- 31. Find the average salary of professors per department, rounded to 2 decimal places
...
-- 34. Using HAVING, list departments where more than 2 students are enrolled across all courses
